...
import { ConfirmTaskCompleted, EmailMessage, EmailMessage2, SuccessMessage } from '../components/PopBoxes';
import { useParams } from 'react-router-dom';
const TaskListGrid = ({prop}) => {
...
<button className='btn' onClick={e=> setTopRightModal(true)}>
  <span className='visible'><CgAttachment  fill='#00ad54' size={20}/></span> Attachments
...
<ConfirmTaskCompleted smShow={smShow} setSmShow={setSmShow} setEmShow={setEmShow} />
{action &&
