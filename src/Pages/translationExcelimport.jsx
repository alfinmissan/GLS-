...
class TranslationExcelimport extends Component {
  constructor(props){
    super(props);
    this.state={
      isOpen: false,
  ...
  handleImport = (event) =>{
    ...
    const url =Url+ 'translation/import';
  ...
  render() {
    return (
      <div style={{"marginTop":"13vh"}}>
        <MainNavbar prop='Import Translations'/>
        {/* <div>
        ...
        <div>
          <p style={{color:"red"}}>Import Rejected Translation already present in Database</p>
          <Card body outline color="secondary" className="restrict-card">
        ...
        <div>
          ...
          {this.state.master_code.map((item,index)=>(<p style={{color:"red"}} key={index}>{index+1}:{item}</p>)) 
...
export default TranslationExcelimport;