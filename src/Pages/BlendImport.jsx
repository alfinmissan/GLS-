...
class BlendExcelimport extends Component {
  constructor(props){
    super(props);
    this.state={
      isOpen: false,
  ...
  handleImport = (event) =>{
    ...
    const url =Url+ 'importexport/blend';
    ...
    return (
      <div style={{"marginTop":"13vh"}}>
        ...
        <div>
          ...
          {this.state.master_code.map((item,index)=>(<p style={{color:"red"}} key={index}>{index+1}:{item['BLEND NAME']}</p>)) 
...
export default BlendExcelimport;