...
export class ItemNoImport extends Component {
    constructor(props){
      super(props);
      this.state={
        isOpen: false,
    ...
    handleImport = (event) =>{
      ...
      const url = Url+'importexport/itemNo';
    ...
    render() {
      return (
        <div style={{"marginTop":"13vh"}}>
          <MainNavbar prop='Import Item Number'/>
          ...
          <div>
            <p style={{color:"red"}}>Import Rejected Item number  already present in Database</p>
            <Card body outline color="secondary" className="restrict-card">
  ...
  export class RegistrationNoImport extends Component {
    constructor(props){
      super(props);
      this.state={
        isOpen: false,
    ...
    handleImport = (event) =>{
      event.preventDefault()
      axios.defaults.headers.common['Authorization'] = Token
      const url = Url+'importexport/regno';
      const formData = new FormData();
      formData.append('files',this.state.file)
      formData.delete('_method');
      const config = {
    ...
    render() {
      return (
        <div style={{"marginTop":"13vh"}}>
          <MainNavbar prop='Import Registration Number'/>
